...
BACKEND_PORT: 3000 (Express API server)
FRONTEND_PORT: 3001 (Next.js application)
...
- Backend should be running on port ${BACKEND_PORT}
- Frontend should be running on port ${FRONTEND_PORT}
- The application URL will be http://localhost:${FRONTEND_PORT}
